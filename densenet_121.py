...
Original file is located at
    https://colab.research.google.com/drive/1P4boF7APrWs891DTIIrGTOyHYIhsITIp
"""
...
train_dir = 'C:/Users/Aakash/Downloads/Diabetic Retinopathy/Final L/train'
test_dir = 'C:/Users/Aakash/Downloads/Diabetic Retinopathy/Final L/test'
...
# Load and compile pre-trained DenseNet121 model without top layer
...
predictions = Dense(5, activation='softmax')(x)  # Add output layer with softmax activation
...
history = model.fit(
    ...
    epochs=50, # Change number of epochs as needed
    verbose=1
)
